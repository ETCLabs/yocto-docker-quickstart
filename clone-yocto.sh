...
git clone -b dunfell https://github.com/Freescale/meta-freescale.git sources/meta-freescale
git clone -b dunfell https://github.com/Freescale/meta-freescale-3rdparty.git sources/meta-freescale-3rdparty
git clone -b dunfell https://github.com/Freescale/meta-freescale-distro.git sources/meta-freescale-distro
